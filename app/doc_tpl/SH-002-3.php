...
$tx        = $db->get_row("SELECT cti_code FROM `sp_project` WHERE `tid` = '$tid' AND `iso`='A03' AND `deleted` = '0'");		
...
$filename = '审表002-3 OHSMS审核方案策划与实施记录('.$ep_name.').doc';
//读入模板文件 
$tpldata  = readover( DOCTPL_PATH . 'doc/SH-002-3.xml' );
